        ...
        <ModalBody>
          <Form onSubmit={(event) => handleSubmit(event)}>
            ...
            <FormGroup>
              ...
              <Input type="text" name="designation" id="designation" defaultValue={obj.designation} />
            </FormGroup>
            <FormGroup>
            ...
            SubComponent={(row) => {
              ...
              return (
                <div style={{ padding: "10px" }}>
                  <ReactTable data={rowData} columns={columns} pageSize={rowData.length} showPagination={false} />
                </div>
              );
            }}
          />
